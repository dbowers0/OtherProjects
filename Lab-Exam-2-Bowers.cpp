...
void getInfo(Lottery lottery[], int& numel) //gets the info from the text file and 7 numbers
{
	...
	cout << "Enter the 7 different, random numbers between 1 and 50 that were selected " << endl;
...
void display(Lottery lottery[], int numel)//sorts structure and displays the information
{
	...
	for (int i = 0; i < numel; i++)
	{
		...
		cout << setw(4) << lottery[i].num1;
		cout << setw(4) << lottery[i].num2;
		cout << setw(4) << lottery[i].num3;
		cout << setw(4) << lottery[i].num4;
		cout << setw(4) << lottery[i].num5;
		cout << setw(4) << lottery[i].num6;
		cout << setw(10) << lottery[i].num7;
		/*cout << setw(2) << " " << lottery[i].num1 << " " << lottery[i].num2 << " " << lottery[i].num3 << " "
			<< lottery[i].num4 << " "
			<< lottery[i].num5 << " " << lottery[i].num6 << " " << lottery[i].num7;*/
		cout << setw(15) << lottery[i].match;
	...
	cout << "*********Students Who Matched All 7 Numbers*********" << endl;
	...
	for (int i = 0; i < numel; i++)
	{
		if (lottery[i].match == 7)
		{
			cout << setw(18) << left << lottery[i].id;
			cout << setw(18) << lottery[i].name;
			cout << setw(10) << lottery[i].match;
			cout << setw(5) << lottery[i].money << endl;
		}
	}
	cout << endl;
	cout << "*********Students Who Matched 6 Numbers*********" << endl;
	cout << "Student ID        Student Name    Matches     Prize $" << endl;
	cout << "_____________________________________________________________" << endl;
	for (int i = 0; i < numel; i++)
	{
	...
	cout << endl;
	cout << "*********Students Who Matched 5 Numbers*********" << endl;
	cout << "Student ID        Student Name    Matches     Prize $" << endl;
	cout << "_____________________________________________________________" << endl;
	for (int i = 0; i < numel; i++)
	{
